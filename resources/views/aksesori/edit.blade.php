...
<head>
    ...
    <title>Edit Aset Aksesoris</title>
                ...
                <div class="row gx-lg-0 gx-xl-8 gy-10 gy-md-13 gy-lg-0 mb-7 mb-md-10 mb-lg-16 align-items-center">
                    <div class="col-lg-8 mx-auto">
                        <div class="title-form mt-3 mb-4" id="title-form">
                            <h1 class="h2">EDIT AKSESORIS</h1>
                        </div>
                        <form method="POST" action="{{ route('aksesori.update', $aksesori->id) }}" class="mb-3">
                            @method('put')
                            @csrf
                            <a class="btn btn-back mb-3" href="/aksesori">Kembali</a>
                            <div class="mb-3">
                                <label for="kode">Kode :</label>
                                <input type="text"
                                    class="form-control shadow-sm bg-body-tertiary rounded @error('kode') is-invalid @enderror"
                                    id="kode" name="kode" readonly
                                    value="{{ old('kode', $aksesori->kode) }}">
                                @error('kode')
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        class="form-control shadow-sm bg-body-tertiary rounded @error('jenis_aksesoris') is-invalid @enderror"
                                        id="jenis_aksesoris" name="jenis_aksesoris"
                                        value="{{ old('jenis_aksesoris', $aksesori->jenis_aksesoris) }}">
                                    @error('jenis_aksesoris')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        id="merek" name="merek"
                                        value="{{ old('merek', $aksesori->merek) }}">
                                    @error('merek')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        id="tahun_perolehan" name="tahun_perolehan" value="{{ old('tahun_perolehan', $aksesori->tahun_perolehan) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('harga_perolehan', $aksesori->harga_perolehan) }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('masa_guna', $aksesori->masa_guna) }}">
                                    @error('masa_guna')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('lama_pakai', $aksesori->lama_pakai) }}">
                                    @error('lama_pakai')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('kondisi', $aksesori->kondisi) }}">
                                    @error('kondisi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('lokasi', $aksesori->lokasi) }}">
                                    @error('lokasi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col mb-3 mt-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('pengguna', $aksesori->pengguna) }}">
                                    @error('pengguna')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
