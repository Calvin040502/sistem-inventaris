<div class="offcanvas offcanvas-start" data-bs-scroll="true" tabindex="-1" id="offcanvasWithBothOptions"
    ...
    <div class="offcanvas-body px-0">
        <ul class="nav nav-pills flex-column mb-sm-auto mb-0 align-items-start" id="menu">
            ...
            @endcan
            <li class="nav-item {{ str_contains(Request::url(), 'kendaraan') ? 'active' : '' }}">
                <a href="{{ route('kendaraan') }}" class="nav-link text-truncate">
                    <img class="transportasi" src="{{ asset('icon/transportasi-hover.svg') }}" alt="">
                    List Aset Kendaraan
                </a>
            </li>            
            <li class="nav-item {{ str_contains(Request::url(), 'elektronik') ? 'active' : '' }}">
                <a href="{{ route('elektronik') }}" class="nav-link text-truncate">
                    <img class="elektronika" src="{{ asset('icon/elektronik-hover.svg') }}" alt="">
                    List Aset Elektronik</a>
            </li>
            <li class="nav-item {{ str_contains(Request::url(), 'furnitur') ? 'active' : '' }}">
                <a href="{{ route('furnitur') }}" class="nav-link text-truncate">
                    <img class="furniture" src="{{ asset('icon/furnitur-hover.svg') }}" alt="">
                    List Aset Furniture</a>
            </li>
            <li class="nav-item {{ str_contains(Request::url(), 'aksesori') ? 'active' : '' }}">
                <a href="{{ route('aksesori') }}" class="nav-link text-truncate">
                    <img class="aksesoris" src="{{ asset('icon/aksesoris-hover.svg') }}" alt="">
