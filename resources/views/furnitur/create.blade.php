...
<head>
    ...
    <title>Tambah Aset Furniture</title>
                ...
                <div class="row gx-lg-0 gx-xl-8 gy-10 gy-md-13 gy-lg-0 mb-7 mb-md-10 mb-lg-16 align-items-center">
                    ...
                    <div class="col-md-12">
                        <form action="{{ route('furnitur.store') }}" method="post">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-6">
                                    <a class="btn btn-back mb-3 shadow-sm" href="/furnitur">Kembali</a>
                                </div>
                                <div class="col-sm-6">
                                    <div class="kode">
                            ...
                            <div class="row mb-3">
                                <div class="col-sm-6">
                                    <label for="jenis_furniture" class="col-form-label">Jenis Furniture</label>
                                    <input type="text" class="form-control shadow-sm bg-body-tertiary rounded" id="jenis_furniture" name="jenis_furniture"
                                        placeholder="Masukkan Jenis Furniture"
