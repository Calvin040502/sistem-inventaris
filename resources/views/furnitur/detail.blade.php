...
<head>
    ...
    <title>Detail Furniture {{ $furnitur->jenis_furniture }} {{ $furnitur->merek }}</title>
    ...
    <div class="body-wrapper">
        ...
        <div class="content">
            <div class="content-title">
                <h1>Detail {{ $furnitur->jenis_furniture }} {{ $furnitur->merek }}</h1>
            </div>
            <div class="row content-output-table">
                <div class="button-ouput">
                    <a style="width: 6rem;" class="btn btn-back" href="{{ route('furnitur') }}"
                        title="List Furniture">Kembali</a>
                    @can('super admin')
                        <button style="width: 6rem;" type="button"
                            onclick="window.location.href='{{ route('furnitur.edit', $furnitur->id) }}'"
                            class="btn btn-edit" title="Edit Data Furniture">Edit</button>
                    @endcan
                </div>
                <div class="col output-column-one">
                    <div class="output">
                        ...
                        <label for="">:</label>
                        <span>{{ $furnitur->kode }}</span>
                    </div>
                    <div class="output">
                        <label class="label-title" for="">Jenis Furniture</label>
                        <label for="">:</label>
                        <span>{{ $furnitur->jenis_furniture }}</span>
                    </div>
                    <div class="output">
                        <label class="label-title" for="">Merek</label>
                        <label for="">:</label>
                        <span>{{ $furnitur->merek }}</span>
                    </div>
                    <div class="output">
                        <label class="label-title" for="">Tahun Perolehan</label>
                        <label for="">:</label>
                        <span>{{ $furnitur->tahun_perolehan }}</span>
                    </div>
                    <div class="output">
                        <label class="label-title" for="">Harga Perolehan</label>
                        <label for="">:</label>
                        <span>{{ $furnitur->harga_perolehan }}</span>
                    </div>
                </div>
