...
<head>
    ...
    <title>Edit Aset Furniture</title>
                ...
                <div class="row gx-lg-0 gx-xl-8 gy-10 gy-md-13 gy-lg-0 mb-7 mb-md-10 mb-lg-16 align-items-center">
                    <div class="col-lg-8 mx-auto">
                        <div class="title-form mt-3 mb-4" id="title-form">
                            <h1 class="h2">EDIT FURNITURE</h1>
                        </div>
                        <form method="POST" action="{{ route('furnitur.update', $furnitur->id) }}" class="mb-3">
                            @method('put')
                            @csrf
                            <a class="btn btn-back mb-3" href="/furnitur">Kembali</a>
                            <div class="mb-3">
                                <label for="kode">Kode :</label>
                                <input type="text"
                                    class="form-control shadow-sm bg-body-tertiary rounded @error('kode') is-invalid @enderror"
                                    id="kode" name="kode" readonly
                                    value="{{ old('kode', $furnitur->kode) }}">
                                @error('kode')
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="jenis_furniture">Jenis Furniture</label>
                                    <input type="text"
                                        class="form-control shadow-sm bg-body-tertiary rounded @error('jenis_furniture') is-invalid @enderror"
                                        id="jenis_furniture" name="jenis_furniture"
                                        value="{{ old('jenis_furniture', $furnitur->jenis_furniture) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        id="merek" name="merek"
                                        value="{{ old('merek', $furnitur->merek) }}">
                                    @error('merek')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        id="tahun_perolehan" name="tahun_perolehan" value="{{ old('tahun_perolehan', $furnitur->tahun_perolehan) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('harga_perolehan', $furnitur->harga_perolehan) }}">
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('masa_guna', $furnitur->masa_guna) }}">
                                    @error('masa_guna')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('lama_pakai', $furnitur->lama_pakai) }}">
                                    @error('lama_pakai')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('kondisi', $furnitur->kondisi) }}">
                                    @error('kondisi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('lokasi', $furnitur->lokasi) }}">
                                    @error('lokasi')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="col mb-3 mt-3">
                                <div class="col-md-12">
                                    ...
                                    <input type="text"
                                        ...
                                        value="{{ old('pengguna', $furnitur->pengguna) }}">
                                    @error('pengguna')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
